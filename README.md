...
This project was built as a **hands-on learning exercise** to understand real-world API testing workflows.
...
* Senior Software Test Engineer | API Testing | Manual Testing | Automation Learner
